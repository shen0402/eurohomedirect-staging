...
(function (factory) {
  ...
  var ProductVariants = /*#__PURE__*/function () {
    ...
    _createClass(ProductVariants, [{
      ...
      /**
       * eurohomedirect automatically adds a "disabled" state to sold out/unavailable variant. When we change the variant we have to recompute
       * all the selectors
       */
  ...
  */
  ...
  var SearchBar = /*#__PURE__*/function () {
    ...
    _createClass(SearchBar, [{
      ...
      /**
       * eurohomedirect allows to display a filter by type. When its value change, we re-do a new search to get the new data
       */
